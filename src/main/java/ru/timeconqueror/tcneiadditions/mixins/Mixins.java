...
public enum Mixins {
    ...
    public static List<String> getEarlyMixins(Set<String> loadedCoreMods) {
        ...
        TCNEIAdditionsLateMixins.LOG.info("Not loading the following EARLY mixins: {}", notLoading.toString());
        return mixins;
    }
    ...
    public static List<String> getLateMixins(Set<String> loadedMods) {
        ...
        TCNEIAdditionsLateMixins.LOG.info("Not loading the following LATE mixins: {}", notLoading.toString());
        return mixins;
    }
